...
//       <div
//         key={c._id}
//         className="comment-item p-3 border rounded-3"
//       >
//         <div className="d-flex gap-3">
//           <SafeAvatar src={c.author?.avatar} size={36} />
//           <div className="flex-grow-1">
...
const ReadingProgressBar = ({ progress, show }) => {
  ...
  return (
    <div className="reading-progress-container position-fixed top-0 start-0 w-100 z-3">
      <ProgressBar 
        now={progress} 
        className="rounded-0" 
        style={{ 
...
const FloatingActions = ({ postId, onCommentClick, onShare, onSave, isSaved }) => {
  ...
  return (
    <div className="floating-actions position-fixed bottom-0 start-0 w-100 d-flex justify-content-center pb-3 z-3">
      <div className="d-flex align-items-center bg-white rounded-pill shadow-lg px-3 py-2 border">
        <LikeButton postId={postId} compact />
        <Button 
          variant="link" 
        ...
        <Button 
          variant="link" 
          className={isSaved ? 'text-warning p-2' : 'text-dark p-2'}
          onClick={onSave}
...
/* ================= ENHANCED SAFE AVATAR ================= */
const SafeAvatar = ({ src, alt, size = 40, className = "" }) => (
  <div 
...
const CommentItem = ({ comment }) => {
  ...
  return (
    <div className="comment-item p-3 border rounded-3 bg-white hover-lift transition-all mb-3">
      <div className="d-flex gap-3">
        <SafeAvatar 
        ...
        <div className="flex-grow-1">
          <div className="d-flex justify-content-between align-items-start mb-1">
            <div>
              <Link 
                to={`/dashboard/user/profile/${comment.author?._id}`}
                className="fw-bold text-decoration-none text-dark"
              >
